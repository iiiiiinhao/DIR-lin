...
for case in range(1,11):
    ...
    # flow_fname = 'flow_case1_lamb10_reso2_noseg.npy'
    ...
    # for i in range(300):
    #     hi, wi, di = ref_lmk_index[i]
    #     h0 = flow[0,0,hi,wi,di]
    #     w0 = flow[0,1,hi,wi,di]
    #     d0 = flow[0,2,hi,wi,di]
    #     ref_lmk1[i] = [h0, w0, d0]
    # #print(ref_lmk1)
    ...
    spacing1 = spacing
    # spacing1[2] = spacing[2]/resize_factor
    ...
    # factor1[:,2] = ref_lmk1[:,2]/mov_lmk0[:,2]
    # factor1 = ref_lmk1/mov_lmk0  #1
    # factor1 = mov_lmk0/ref_lmk1  #2
    factor1 = ref_lmk_index1/ref_lmk1  #3
    ref_lmk1_xs = (ref_lmk0 - ref_lmk_index1)*factor1
    # ref_lmk1_xs = (ref_lmk0 - ref_lmk_index1)
